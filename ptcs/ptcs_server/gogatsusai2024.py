...
def create_bridge() -> Bridge2:
    ...
    bridge.add_point(PointClient("j00", ADDRESS_POINT0))
    bridge.add_point(PointClient("j02", ADDRESS_POINT1))
    bridge.add_point(PointClient("j04", ADDRESS_POINT2))
    bridge.add_point(PointClient("j06", ADDRESS_POINT3))
    bridge.add_point(PointClient("j08", ADDRESS_POINT4))
    bridge.add_point(PointClient("j10", ADDRESS_POINT7))
