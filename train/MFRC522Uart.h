/**
 * Library to use Arduino MFRC522 module on the Serial (UART).
 * 
 * This library is the almost "copy" of <MFRC522.h> (https://github.com/miguelbalboa/rfid)
 * by Dr.Leong, Miguel Balboa, Søren Thing Andersen, Tom Clement and many more.
 * A lot of thanks for them!
 * 
 * @authors thgcMtdh
 * 
 * !! This library is only for ESP32 Dev Module. Operations on other platform is under testing.
 */
#ifndef MFRC522Uart_h
#define MFRC522Uart_h
...
public:
	...
	/////////////////////////////////////////////////////////////////////////////////////
	// MFRC522Uart();
	MFRC522Uart(HardwareSerial* serial, byte mfrc522RxPin, byte mfrc522TxPin, byte resetPowerDownPin);
	// MFRC522Uart(byte chipSelectPin, byte resetPowerDownPin);
