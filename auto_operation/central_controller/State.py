...
class State:
    ...
    def __init__(self):
        ...
        self.sectionList.append(Section(0, self.getJunctionById(3), self.getJunctionById(0), Junction.ServoState.NoServo, Junction.ServoState.NoServo, State.STRAIGHT_UNIT * 4))
        ...
        self.sectionList.append(Section(2, self.getJunctionById(1), self.getJunctionById(2), Junction.ServoState.Straight, Junction.ServoState.Straight, State.STRAIGHT_UNIT * 4))
        self.sectionList.append(Section(3, self.getJunctionById(1), self.getJunctionById(2), Junction.ServoState.Curve, Junction.ServoState.Curve, State.STRAIGHT_UNIT * 4))
        self.sectionList.append(Section(4, self.getJunctionById(2), self.getJunctionById(3), Junction.ServoState.NoServo, Junction.ServoState.NoServo, State.STRAIGHT_UNIT * 4 + State.CURVE_UNIT * 4))
        ...
        self.getSectionById(2).putStation(self.getStationById(1), State.STRAIGHT_UNIT * 2)  # section2に駅1を追加
        self.getSectionById(3).putStation(self.getStationById(1), State.STRAIGHT_UNIT * 2)  # section3に駅1を追加
